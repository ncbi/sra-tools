...
#ifndef YY_VCF_HOME_BOSHKINS_NCBI_DEVEL_SRA_TOOLS_TOOLS_VCF_LOADER_ZZ_VCF_GRAMMAR_H_INCLUDED
# define YY_VCF_HOME_BOSHKINS_NCBI_DEVEL_SRA_TOOLS_TOOLS_VCF_LOADER_ZZ_VCF_GRAMMAR_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
#if YYDEBUG
extern int VCF_debug;
#endif
...
int VCF_parse (VCFParseBlock* pb);

#endif /* !YY_VCF_HOME_BOSHKINS_NCBI_DEVEL_SRA_TOOLS_TOOLS_VCF_LOADER_ZZ_VCF_GRAMMAR_H_INCLUDED  */
...
static void
yy_symbol_value_print (FILE *yyo, int yytype, YYSTYPE const * const yyvaluep, VCFParseBlock* pb)
{
  FILE *yyoutput = yyo;
  YYUSE (yyoutput);
  YYUSE (pb);
...
static void
yy_symbol_print (FILE *yyo, int yytype, YYSTYPE const * const yyvaluep, VCFParseBlock* pb)
{
  YYFPRINTF (yyo, "%s %s (",
...
static void
yy_reduce_print (yy_state_t *yyssp, YYSTYPE *yyvsp, int yyrule, VCFParseBlock* pb)
{
...
yyreduce:
  ...
  case 5:
                                                        { pb->metaLine(pb, & yyvsp[-3], &yyvsp[-1]); }
    break;
  ...
  case 15:
                                { pb->keyValue(pb, & yyvsp[-2], &yyvsp[0]); }
    break;

  case 17:
                                    { pb->headerItem(pb, & yyvsp[0]); }
    break;
  ...
  case 22:
                                { pb->openDataLine(pb); pb->dataItem(pb, & yyvsp[0]); }
    break;

  case 23:
                                { pb->dataItem(pb, & yyvsp[0]); }
    break;
