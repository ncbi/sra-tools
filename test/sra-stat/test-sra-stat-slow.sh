...
echo Testing sra-stat-slow from ${bin_dir}
...
NCBI_SETTINGS=/ ${bin_dir}/sra-stat -x SRR586259  | perl -w strip-path-sdlr.pl > actual/SRR586259
...
NCBI_SETTINGS=/ ${bin_dir}/sra-stat -x SRR495844 | perl -w strip-path-sdlr.pl  > actual/SRR495844
...
NCBI_SETTINGS=/ ${bin_dir}/sra-stat -x SRR390427 > actual/SRR390427
...
NCBI_SETTINGS=/ ${bin_dir}/sra-stat -x SRR360929 > actual/SRR360929
