...
sub REQ { (
            ...
            { name    => 'fuse',
              ...
              origin  => 'E',
              type    => 'LIO',
#             include => 'fuse.h',            lib     => 'libfuse.a',
            },
            { name    => 'hdf5',
              option  => 'with-hdf5-prefix',
              origin  => 'E',
              type    => 'LIO',
#             pkgpath => '/usr',              usrpath => '$HOME',
#             include => 'hdf5.h',            lib     => 'libhdf5.a',
            },
            { name    => 'magic',
              option  => 'with-magic-prefix',
              origin  => 'E',
              type    => 'LIO',
#             include => 'magic.h',           lib     => 'libmagic.$SHLX',
            },
            { name    => 'xml2',
              ...
              type    => 'LIO',
#             pkgpath => '/usr',              usrpath => '$HOME',
#             include => 'libxml2/xmlreader.h', lib     => 'libxml2.a',
        } ) }
1
