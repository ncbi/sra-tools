...
echo "example number 3: download the remote file, no buffering, no cachefile"
...
echo "example number 6: download the remote file, no cachefile"
echo "                  in 32k blocks, wraped in a buffer-file with 128k blocks"
execute "time kget $URL --buffer 128k"

echo "example number 7: download the remote file, using a cache-file "
...
echo "example number 9: download the remote file, no buffering, no cachefile"
