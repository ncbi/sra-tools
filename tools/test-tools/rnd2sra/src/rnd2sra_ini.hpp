...
class rnd2sra_ini {
    private:
        ...
        row_offset_pair_ptr f_read_filter_elements_diff;
        ...
        rnd2sra_ini( const IniPtr ini, const MainParamsPtr main_params ) {
            ...
            f_read_filter_elements_diff = row_offset_pair::make( ini -> get( "read_filter_elements_diff", "" ) );
        ...
        row_offset_pair_ptr get_read_filter_elements_diff( void ) const { return f_read_filter_elements_diff; }
    ...
    public:
        ...
        int32_t read_filter_elements_diff( int64_t row ) const {
            return get_read_filter_elements_diff() -> offset( row );
        }
