...
# $3 - work directory (actual results and temporaries created under actual/)
# $4 - test case ID
# $5 - expected result code from sharq
# $6 - string to look for in stderr
...
GREP="grep -q \"$GREP_FOR\" $TEMPDIR/load.stderr"
eval $GREP
rc="$?"
if [ "$rc" != "0" ] ; then
