 ...
 */
rc_t make_progressbar( struct progressbar ** pb );
 ...
 *  does not output anything
 */
rc_t destroy_progressbar( struct progressbar * pb );
 ...
 */
rc_t update_progressbar( struct progressbar * pb, const uint8_t fract_digits,
